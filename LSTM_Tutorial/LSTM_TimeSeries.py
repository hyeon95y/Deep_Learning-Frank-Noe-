...
print('*created dataset x_train.shape', x_train.shape)
print('*created dataset x_train[0]', x_train[0])
print('*created dataset y_train.shape', y_train.shape)
print('*created dataset y_train[0]', y_train[0])
